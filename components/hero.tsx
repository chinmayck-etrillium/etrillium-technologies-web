...
export default function Hero() {
  ...
  const handleClosePopup = () => {
    // Hide the popup
    setShowPopup(false);
    console.log("Popup closed"); // Check if this log appears in the console
  };
  return (
    <section>
      {/* Popup */}
        ...
        <div className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-white p-8 rounded-lg">
            ...
            <div className="flex justify-center">
              <button
                className="btn text-white bg-purple-600 hover:bg-black-100 w-full mb-4 sm:w-auto  mr-4"
                onClick={handleClosePopup}
              >
                Close
              </button>
              <button
                className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto"
                onClick={() => (window.location.href = "tel:+918089524776")}
              >
                Contact Us
              </button>
            </div>
